...
type Config struct {
	...
	CLOUDINARY_CLOUD_NAME string   `env:"CLOUDINARY_CLOUD_NAME" env-required:"true"`
	CLOUDINARY_API_KEY    string   `env:"CLOUDINARY_API_KEY" env-required:"true"`
	CLOUDINARY_API_SECRET string   `env:"CLOUDINARY_API_SECRET" env-required:"true"`
	FFMPEG_PATH           string   `env:"FFMPEG_PATH" env-required:"true"`
	FFPROBE_PATH          string   `env:"FFPROBE_PATH" env-required:"true"`
